...
public sealed class PublishedApiDocumentTests
{
    ...
    private HealthController HealthFor(IRequestStore store)
        => new HealthController(
            ...
            new FulfilmentSweep(store, new FakeLibrary(), new TestClock(Started), new RecordingJournal(), new RecordingSink(), new RecordingRequesterNotice(), new RecordingLogger()),
            new BridgeWatch(),
